...
<html class="no-js" lang="en">
  ...
  <body>
    ...
    <section class="cs_page_header position-relative background-filled d-flex align-items-center justify-content-between" data-src="assets/img/page_header_1.jpg">
      <div class="container position-relative z-index-1">
        ...
        <h1 class="cs_fs_48 cs_fs_lg_36 text-white m-0">Why Work With Us</h1>
      </div>
  ...
  <p>TBL stands out as a professional marketing company with a unique approach:</p>

  <ul>
    <li>
      <b>Channel Partner:</b> Our company reaches out to and becomes a channel partner with the customers who, in turn, rely on TBL. 
      We aim to establish a close rapport with the technical and commercial teams of customers to make business transactions swift and efficient.
    </li>
    <li>
      <b>One-Stop Shop:</b> TBL offers a basket of products that make it easier for customers to shop through us, serving as a one-stop shop for mechanical engineering products.
    </li>
    <li>
      <b>Global Sourcing Base:</b> TBL has a vast global sourcing base, enabling the procurement of genuine quality spares, accessories, and equipment 
      in the fastest possible time at the most reasonable and justified prices.
    </li>
    <li>
      <b>Proximity to Customers:</b> TBL has offices close to customers to attend to any urgent needs within 12 hours.
    </li>
    <li>
      <b>Technical Expertise:</b> TBL has its own technical team to understand the requirements of customers, ensuring the correct supply of products.
    </li>
    <li>
      <b>Manufacturer Support:</b> TBL receives technical backup from principal manufacturers to assist its own team of service engineers.
    </li>
    <li>
      <b>Customer-Centric Focus:</b> TBL maintains a strong focus on customer satisfaction and enjoys long, uninterrupted relationships with its customers.
    </li>
  </ul>
  </div>
    <!-- End Content Section -->
