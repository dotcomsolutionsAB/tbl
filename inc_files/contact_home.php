        ...
        <div class="row align-items-center">
          <div class="col-xl-5 col-lg-6">
            ...
            <div class="d-flex align-items-center cs_mb_30">
              ...
              <div>
                ...
                <h2 class="text-white m-0 fw-medium cs_fs_22 cs_fs_lg_18 cs_lh_base">+91 9836000409</h2>
              </div>
            </div>
            <div class="d-flex align-items-center cs_mb_30">
              <div class="d-flex align-items-center justify-content-center cs_height_90 cs_width_90 cs_height_lg_80 cs_width_lg-80 cs_rounded_10 flex-none cs_mr_20 bg-accent">
              ...
              <div>
                ...
                <h2 class="text-white m-0 fw-medium cs_fs_22 cs_fs_lg_18 cs_lh_base">tbl@tblindustrial.com</h2>
              </div>
            </div>
            <div class="d-flex align-items-center">
              ...
              <div>
                ...
                <h2 class="text-white m-0 fw-medium cs_fs_22 cs_fs_lg_18 cs_lh_base">14, Chittaranjan Avenue <br> Kolkata - 700 072, W.B. India</h2>
              </div>
            </div>
          </div> 
          <div class="col-xl-5 col-lg-6 offset-xl-1 cs_mt_lg_55">
            <div class="cs_contact_wrap position-relative">
              ...
              <div class="cs_contact_image d-none d-xl-block wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.4s"><img src="#" alt=""></div>
            </div>
          </div>
        </div>
      </div>
