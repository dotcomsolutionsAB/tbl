...
<html class="no-js" lang="en">
  ...
  <body>
      ...
      <div class="container position-relative z-index-1">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb text-white cs_fs_18 cs_mb_5">
            ...
            <li class="breadcrumb-item active">Carbon Brush Technology</li>
          </ol>
        </nav>
        <h1 class="cs_fs_48 cs_fs_lg_36 text-white m-0">Carbon Brush Technology</h1>
      </div>
    ...
    <?php include("inc_files/service_2.php"); ?>
    <!-- End Service Section -->
